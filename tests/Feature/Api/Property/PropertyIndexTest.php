...
class PropertyIndexTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->route = '/api/v1/property/index';
    ...
    */
    ...
    public function test_renter_gets_own_properties()
    {
        $response = $this->makeRequest($this->users[Role::RoleRenter], $this->route);

        $expectedData = Property::where('renter_id', '=', $this->users[Role::RoleRenter]['user']->renter->renter_id)
            ->orderBy('created_at')
            ->paginate(10)->toArray();
